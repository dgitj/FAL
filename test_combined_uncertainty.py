"""
Test script for the HybridEntropyKAFALEntropyFirst strategy with combined local-global uncertainty.
...
def run_test():
    ...
    print("Starting HybridEntropyKAFALEntropyFirst strategy with combined uncertainty test...")
