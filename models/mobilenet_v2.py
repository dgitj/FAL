"""
MobileNetV2 for CIFAR datasets in PyTorch
Adapted to match the interface of preact_resnet.py
"""
import torch
...
class MobileNetV2_CIFAR(nn.Module):
    """MobileNetV2 adapted for CIFAR datasets (32x32 images)"""
    ...
    def __init__(self, num_classes=10, width_mult=1.0):
        ...
        self.features = [self._conv_bn(3, input_channel, 1)]  # Changed stride from 2 to 1
...
def mobilenet_v2_cifar(num_classes=10, **kwargs):
    """
    Constructs a MobileNetV2 model for CIFAR.
    
    Args:
        num_classes (int): Number of output classes
        
    Returns:
        MobileNetV2 model with interface matching preact_resnet8_cifar
    """
    model = MobileNetV2_CIFAR(num_classes=num_classes, **kwargs)
    return model
