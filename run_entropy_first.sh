#!/bin/bash
#SBATCH --job-name=entropy_first
#SBATCH --partition=gpu_h100
#SBATCH --output=/home/ka/ka_kastel/ka_wu0175/FAL/logs/entropy_first_%A_%a.out
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
#SBATCH --mem=16G
...
# Run two strategies for comparison
strategies=(HybridEntropyKAFAL HybridEntropyKAFALEntropyFirst)  
